                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6" style="margin-right:0">
                                <div class="row no-margin">
                                    ...
                                    <div class="col-md-4" style="display: flex; margin-top:30px">
                                        <input class="check" num="1" id="check_1" type="checkbox" style="margin:15px 10px 0 0">
                                ...
                                <div class="row no-margin">
                                    ...
                                    <div class="col-md-4" style="display: flex; margin-top:30px">
                                        <input class="check" num="2" id="check_2" type="checkbox" style="margin:15px 10px 0 0">
                                        <h4>correct answer</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6" style="margin-right:0">
                                <div class="row no-margin">
                                    ...
                                    <div class="col-md-4" style="display: flex; margin-top:30px">
                                        <input class="check" num="3" id="check_3" type="checkbox" style="margin:15px 10px 0 0">
                                        <h4>correct answer</h4>
                                    </div>
                                </div>
                                <div class="row no-margin">
                                    ...
                                    <div class="col-md-4" style="display: flex; margin-top:30px"">
                                        <input class="check" num="4" id="check_4" type="checkbox" style="margin:15px 10px 0 0">
                                        <h4>correct answer</h4>
                                    </div>
                                </div>
                            </div>
