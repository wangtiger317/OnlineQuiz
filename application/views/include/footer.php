<footer class="main-footer">IfQuiz@develop.com  &nbsp;&nbsp;&nbsp;&nbsp;&copy 2019</footer>
    <!-- /.control-sidebar -->
...
<script type="text/javascript" src="<?php echo base_url('assets/js/examples.datatables.editable.js'); ?>"></script>
